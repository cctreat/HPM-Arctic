...
%************************
% core data for RMSE
obsCore_age = [-50 1020 1490 1660 1680 2170 2750 3060 3480 4030 4330 6010 6580];
obsCore_depths = [1.5 10.5 41.5 45.5 58.5 66.5 83.5 91.5 114.5 125 155.5 182 195.5];
...
depth_runOnOff = 0.75*2;% depth when run-on switches to runoff
depth_MnOmTrans = 1.2; %depth of the transition from minerotrophy to ombrotrophy.
...
%'anoxia_scale_length','anoxia_scale_length2',  