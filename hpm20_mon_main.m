...
%save('soil_node_temp_month.mat', 'soil_node_temp_month_save')
save(soiltemp_filename, 'soil_node_temp_month_save')
...
results_13 = [time ann_temp_forcing ann_precip_forcing ann_aet ann_runoff ann_WTD ann_NPP ...
