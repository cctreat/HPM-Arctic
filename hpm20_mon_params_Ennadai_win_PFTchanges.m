...
site_name = 'Ennadai';
sim_name = '_6_PFT_npp_optim1A_2015_newdrivers';
...
depth_runOnOff = 0.6 ;% depth when run-on switches to runoff
depth_MnOmTrans = 1.0; %depth of the transition from minerotrophy to ombrotrophy.
...
PFT_param(4,:) = [ 0.25   0.09    1.5    1.0   2.   19.   0.8    1.0    9.     1.3*0.5      1.0     0.15  ]; % shrub aboveground
PFT_param(5,:) = [ 0.25   0.09    1.5    1.0   2.   19.   0.8    1.0    9.     0.7*0.5      0.0     0.10  ]; % shrub belowground
...
%     Roff_c2a = 1.;  % peat height needed to get base run-off (factor = 1 +c2*(H-c2a))
    ...
    anoxia_scale_length = 1.04; % 1.873;
    anoxia_scale_length1 = anoxia_scale_length;
    anoxia_scale_length2 = 1.98; % 0.2043;
