...
ann_temp = -7;  % site mean annual temp (C) for parameter values
ann_ppt = 0.13;  % site total annual precipitation (m/y) for parameter values
ann_ET_0 = 0.2;  % site base evapotranspiration (m/y) used to compute base run-off

latitude = 69.5; % degrees North > 0
