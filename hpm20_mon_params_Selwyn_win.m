...
depth_MnOmTrans = 0.6; %depth of the transition from minerotrophy to ombrotrophy.
depth_runOnOff = 0.4 ;% depth when run-on switches to runoff
...
%     Roff_c2a = 1.;  % peat height needed to get base run-off (factor = 1 +c2*(H-c2a))
    ...
    anoxia_scale_length = 2.46;
    anoxia_scale_length1 = anoxia_scale_length;
    anoxia_scale_length2 = 1.075;
