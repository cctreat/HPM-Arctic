...
site_name = 'TKP';
sim_name = '_1I2';
monthly_T_P_name =  '_monthly_T_P_6620BP_2015CE'; 
...
depth_runOnOff = 2.1;% depth when run-on switches to runoff
depth_MnOmTrans = depth_runOnOff; %depth of the transition from minerotrophy to ombrotrophy.
